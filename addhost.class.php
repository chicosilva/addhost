...
class AddHost {
    ...
    public function setHTAccessOn($value) {
        $this->htaccessCreation = $value;
    }

    public function setComposerDownloadOn($value) {
        $this->composerDownload = $value;
    }

    public function setErrorLogOn($value) {
    ...
    private function downloadComposer() {
        ...
        $developerName = ( defined('DEVELOPER_NAME') ) ? DEVELOPER_NAME : 'Your name';

        $developerMail = ( defined('DEVELOPER_MAIL') ) ? DEVELOPER_MAIL : 'your-dev@mail.net';
    ...
    public function checkHost() {
        ...
        } elseif (in_array($this->hostname, $matches)) {
